...
const Login = ({ showPassword, setShowPassword, alertMsg, setAlertMsg }) => {
  ...
  const handleForgotPass = async () => {
    ...
    try {
      ...
      ProgressBar.done();
      setAlertMsg({ show: true, type: 'error', message: "Email sent. Check your spam folder." });
    } catch (err) {
      ProgressBar.done();
      setAlertMsg({ show: true, type: 'error', message: "Unable to send email. Try again later." });
    }
  };
    ...
    <div className="signup-div">
      <div className="signup-card">
        ...
        <h1 className="Signup-h1">
          Welcome Back to <span> Xyz <br /> Login </span>to Continue
        </h1>
        <div className="input-boxes">
          <form onSubmit={handleLogin}>
            ...
            />
            <div className="form-text" style={{ color: "#6b4d4d", marginLeft: "12px", marginBottom: "5px" }}>
            ...
            <div className="remeberMe">
              ...
              <label htmlFor="rememberMe" style={{ marginLeft: "5px", position: "relative", bottom: "2px" }} className="remeber-label">
                Remember Me
              </label>
            </div>
